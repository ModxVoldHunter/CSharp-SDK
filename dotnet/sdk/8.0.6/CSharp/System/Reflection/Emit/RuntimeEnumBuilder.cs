...
internal sealed class RuntimeEnumBuilder : EnumBuilder
{
	...
	internal RuntimeEnumBuilder(string name, Type underlyingType, TypeAttributes visibility, RuntimeModuleBuilder module)
	{
		if (((uint)visibility & 0xFFFFFFF8u) != 0)
		{
			throw new ArgumentException(SR.Argument_ShouldOnlySetVisibilityFlags, "name");
		}
		m_typeBuilder = new RuntimeTypeBuilder(name, visibility | TypeAttributes.Sealed, typeof(Enum), null, module, PackingSize.Unspecified, 0, null);
