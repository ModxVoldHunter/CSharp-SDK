...
public struct BlobReader
{
	...
	private static ReadOnlySpan<uint> CorEncodeTokenArray => RuntimeHelpers.CreateSpan<uint>((RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
	...
	{
		Marshal.Copy((nint)GetCurrentPointerAndAdvance(byteCount), buffer, bufferOffset, byteCount);
	}
