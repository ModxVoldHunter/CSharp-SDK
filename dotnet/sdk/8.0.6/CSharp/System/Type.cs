...
public abstract class Type : MemberInfo, IReflect
{
	...
	public static Type? GetType(string typeName, bool throwOnError, bool ignoreCase)
	{
		...
		return TypeNameParser.GetType(typeName, System.Reflection.Assembly.GetExecutingAssembly(ref stackMark), throwOnError, ignoreCase);
	}
	...
	{
		StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
		return TypeNameParser.GetType(typeName, System.Reflection.Assembly.GetExecutingAssembly(ref stackMark), throwOnError);
	}
	...
	{
		StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
		return TypeNameParser.GetType(typeName, System.Reflection.Assembly.GetExecutingAssembly(ref stackMark));
	}
	...
	{
		StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
		return TypeNameParser.GetType(typeName, assemblyResolver, typeResolver, (assemblyResolver != null && typeResolver != null) ? null : System.Reflection.Assembly.GetExecutingAssembly(ref stackMark));
	}
	...
	{
		StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
		return TypeNameParser.GetType(typeName, assemblyResolver, typeResolver, (assemblyResolver != null && typeResolver != null) ? null : System.Reflection.Assembly.GetExecutingAssembly(ref stackMark), throwOnError);
	}
	...
	{
		StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
		return TypeNameParser.GetType(typeName, assemblyResolver, typeResolver, (assemblyResolver != null && typeResolver != null) ? null : System.Reflection.Assembly.GetExecutingAssembly(ref stackMark), throwOnError, ignoreCase);
	}
