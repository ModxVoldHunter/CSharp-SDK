...
public static class Math
{
	...
	private static ReadOnlySpan<double> RoundPower10Double => RuntimeHelpers.CreateSpan<double>((RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
	...
	public static double Abs(double value)
	{
		...
		return BitConverter.UInt64BitsToDouble(num & 0x7FFFFFFFFFFFFFFFuL);
	}
	...
	public static float Abs(float value)
	{
		...
		return BitConverter.UInt32BitsToSingle(num & 0x7FFFFFFFu);
	}
	...
	{
		if (Sse2.IsSupported ? true : false)
		{
	...
	public static double Round(double a)
	{
		...
		if (num2 <= 1022)
		{
			...
			double x = ((num2 == 1022 && double.ExtractTrailingSignificandFromBits(num) != 0L) ? 1.0 : 0.0);
			return CopySign(x, a);
		}
		if (num2 >= 1075)
		{
	...
	public static double Round(double value, int digits, MidpointRounding mode)
	{
		...
		if (Abs(value) < 10000000000000000.0)
		{
			...
			value = mode switch
			{
				...
				MidpointRounding.AwayFromZero => Truncate(value + CopySign(0.49999999999999994, value)), 
