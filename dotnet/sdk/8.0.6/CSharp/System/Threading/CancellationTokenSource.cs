...
public class CancellationTokenSource : IDisposable
{
	...
	public Task CancelAsync()
	{
		...
		if (TransitionToCancellationRequested())
		{
			...
			if (registrations != null)
			{
				...
				bool flag = registrations.Callbacks != null;
	...
	{
		ThrowIfDisposed();
		if (_state == 0 && (_timer == null || (_timer is TimerQueueTimer timerQueueTimer && timerQueueTimer.Change(uint.MaxValue, uint.MaxValue) && !timerQueueTimer._everQueued)))
		{
