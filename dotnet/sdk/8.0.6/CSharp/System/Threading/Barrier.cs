...
public class Barrier : IDisposable
{
	...
	{
		ArgumentOutOfRangeException.ThrowIfNegative(participantCount, "participantCount");
		ArgumentOutOfRangeException.ThrowIfGreaterThan(participantCount, 32767, "participantCount");
	...
	public long AddParticipants(int participantCount)
	{
		...
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(participantCount, "participantCount");
		ArgumentOutOfRangeException.ThrowIfGreaterThan(participantCount, 32767, "participantCount");
		...
		long num = ((sense != (currentPhaseNumber % 2 == 0)) ? (currentPhaseNumber + 1) : currentPhaseNumber);
