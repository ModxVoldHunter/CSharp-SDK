...
public abstract class MemberDescriptor
{
	...
	{
		ArgumentNullException.ThrowIfNull(descr, "descr");
		_name = descr.Name;
		_displayName = _name;
	...
	{
		ArgumentNullException.ThrowIfNull(oldMemberDescriptor, "oldMemberDescriptor");
	...
	{
		ArgumentNullException.ThrowIfNull(attributeList, "attributeList");
	...
	{
		ArgumentNullException.ThrowIfNull(componentClass, "componentClass");
		MethodInfo methodInfo = ((!publicOnly) ? componentClass.GetMethod(name, BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic, null, args, null) : componentClass.GetMethod(name, args));
