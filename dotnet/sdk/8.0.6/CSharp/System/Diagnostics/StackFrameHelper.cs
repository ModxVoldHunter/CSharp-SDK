...
{
	private delegate void GetSourceLineInfoDelegate(Assembly assembly, string assemblyPath, nint loadedPeAddress, int loadedPeSize, bool isFileLayout, nint inMemoryPdbAddress, int inMemoryPdbSize, int methodToken, int ilOffset, out string sourceFile, out int sourceLine, out int sourceColumn);
	...
	public MethodBase GetMethodBase(int i)
	{
		...
		IRuntimeMethodInfo typicalMethodDefinition = RuntimeMethodHandle.GetTypicalMethodDefinition(new RuntimeMethodInfoStub(num, this));
