...
public abstract class TraceListener : MarshalByRefObject, IDisposable
{
	...
	private void WriteFooter(TraceEventCache eventCache)
	{
		...
		if (IsEnabled(TraceOptions.DateTime))
		{
			...
			handler = new DefaultInterpolatedStringHandler(9, 1, formatProvider, span2);
		...
		if (IsEnabled(TraceOptions.Timestamp))
		{
			...
			handler = new DefaultInterpolatedStringHandler(10, 1, formatProvider, span2);
			handler.AppendLiteral("Timestamp=");
			handler.AppendFormatted(eventCache.Timestamp);
			WriteLine(string.Create(provider2, initialBuffer2, ref handler));
		}
