...
internal sealed class ScalarTypeInfo : TraceLoggingTypeInfo
{
	...
	{
		return s_intptr ?? (s_intptr = new ScalarTypeInfo(typeof(nint), Statics.IntPtrType));
	}

	public static TraceLoggingTypeInfo UIntPtr()
	{
		return s_uintptr ?? (s_uintptr = new ScalarTypeInfo(typeof(nuint), Statics.UIntPtrType));
	}
