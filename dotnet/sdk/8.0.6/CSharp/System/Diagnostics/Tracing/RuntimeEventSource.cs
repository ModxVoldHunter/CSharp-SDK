...
internal sealed class RuntimeEventSource : EventSource
{
	public static class Keywords
	{
		...
		public const EventKeywords ProcessorCount = (EventKeywords)2L;
	}
	...
	[Event(2, Level = EventLevel.Informational, Keywords = (EventKeywords)2L)]
	internal void ProcessorCount(int processorCount)
	{
		WriteEvent(2, processorCount);
	}
	...
	protected override void OnEventCommand(EventCommandEventArgs command)
	{
		...
		{
			_workingSetCounter = new PollingCounter("working-set", this, () => (double)Environment.WorkingSet / 1000000.0)
			{
		...
		{
			_gcHeapSizeCounter = new PollingCounter("gc-heap-size", this, () => (double)GC.GetTotalMemory(forceFullCollection: false) / 1000000.0)
			{
		...
		if (_gen0BudgetCounter == null)
		{
			_gen0BudgetCounter = new PollingCounter("gen-0-gc-budget", this, () => GC.GetGenerationBudget(0) / 1000000)
			{
		...
		{
			_committedCounter = new PollingCounter("gc-committed", this, () => (double)GC.GetGCMemoryInfo().TotalCommittedBytes / 1000000.0)
			{
		...
		if (_totalGcPauseTimeCounter == null)
		{
			_totalGcPauseTimeCounter = new IncrementingPollingCounter("total-pause-time-by-gc", this, () => GC.GetTotalPauseDuration().TotalMilliseconds)
			{
