...
public class ProcessThread : Component
{
	...
	public unsafe nint StartAddress => (nint)_threadInfo._startAddress;
	...
	public int IdealProcessor
	{
		set
		{
			using Microsoft.Win32.SafeHandles.SafeThreadHandle handle = OpenThreadHandle(32);
	...
	private bool PriorityBoostEnabledCore
	{
		get
		{
			using Microsoft.Win32.SafeHandles.SafeThreadHandle handle = OpenThreadHandle(64);
	...
	public nint ProcessorAffinity
	{
		set
		{
			using Microsoft.Win32.SafeHandles.SafeThreadHandle handle = OpenThreadHandle(96);
