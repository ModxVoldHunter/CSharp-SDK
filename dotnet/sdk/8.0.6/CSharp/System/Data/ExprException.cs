...
internal static class ExprException
{
	...
	{
		return _Eval(System.SR.Format(System.SR.Expr_DatatypeConversion, type1.ToString(), type2.ToString()));
	}

	public static Exception DatavalueConversion(object value, Type type)
	{
		return _Eval(System.SR.Format(System.SR.Expr_DatavalueConversion, value.ToString(), type.ToString()));
	}
	...
	{
		return _Eval(System.SR.Format(System.SR.Expr_FilterConversion, expr));
	}
