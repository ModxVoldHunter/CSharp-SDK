...
public sealed class RawSecurityDescriptor : GenericSecurityDescriptor
{
	...
	private static byte[] BinaryFormFromSddlForm(string sddlForm)
	{
		...
		nint resultSd = IntPtr.Zero;
		uint resultSdLength = 0u;
		byte[] array = null;
		try
		{
			if (!global::Interop.Advapi32.ConvertStringSdToSd(sddlForm, 1u, out resultSd, ref resultSdLength))
			{
				...
				default:
					throw new Win32Exception(lastPInvokeError, System.SR.Format(System.SR.AccessControl_UnexpectedError, lastPInvokeError));
				case 0:
					break;
				}
			}
