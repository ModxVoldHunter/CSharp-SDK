...
public class HMACSHA3_384 : HMAC
{
	...
	public static bool IsSupported { get; } = HashProviderDispenser.MacSupported("SHA3-384");
	...
	public HMACSHA3_384()
		: this(RandomNumberGenerator.GetBytes(104))
	{
	}
	...
	public HMACSHA3_384(byte[] key)
	{
		...
		CheckSha3Support();
		base.HashName = "SHA3-384";
		_hMacCommon = new HMACCommon("SHA3-384", key, 104);
		base.Key = _hMacCommon.ActualKey;
	...
	public static bool TryHashData(ReadOnlySpan<byte> key, ReadOnlySpan<byte> source, Span<byte> destination, out int bytesWritten)
	{
		...
		bytesWritten = HashProviderDispenser.OneShotHashProvider.MacData("SHA3-384", key, source, destination);
		return true;
	}
	...
	public static int HashData(ReadOnlySpan<byte> key, Stream source, Span<byte> destination)
	{
		...
		CheckSha3Support();
		return LiteHashProvider.HmacStream("SHA3-384", key, source, destination);
	}
	...
	public static byte[] HashData(ReadOnlySpan<byte> key, Stream source)
	{
		...
		CheckSha3Support();
		return LiteHashProvider.HmacStream("SHA3-384", 48, key, source);
	}
	...
	public static ValueTask<byte[]> HashDataAsync(ReadOnlyMemory<byte> key, Stream source, CancellationToken cancellationToken = default(CancellationToken))
	{
		...
		CheckSha3Support();
		return LiteHashProvider.HmacStreamAsync("SHA3-384", key.Span, source, cancellationToken);
	}
	...
	public static ValueTask<int> HashDataAsync(ReadOnlyMemory<byte> key, Stream source, Memory<byte> destination, CancellationToken cancellationToken = default(CancellationToken))
	{
		...
		CheckSha3Support();
		return LiteHashProvider.HmacStreamAsync("SHA3-384", key.Span, source, destination, cancellationToken);
	}
