...
internal static class OidLookup
{
	...
	static OidLookup()
	{
		...
		s_friendlyNameToOid = new Dictionary<string, string>(114, StringComparer.OrdinalIgnoreCase);
	...
	private static void InitializeLookupDictionaries()
	{
		...
		AddEntry("1.2.840.10045.3.1.7", "ECDSA_P256", new string[4] { "nistP256", "secP256r1", "x962P256v1", "ECDH_P256" });
		AddEntry("1.3.132.0.34", "ECDSA_P384", new string[3] { "nistP384", "secP384r1", "ECDH_P384" });
		AddEntry("1.3.132.0.35", "ECDSA_P521", new string[3] { "nistP521", "secP521r1", "ECDH_P521" });
