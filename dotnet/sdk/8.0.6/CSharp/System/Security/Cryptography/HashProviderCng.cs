...
internal sealed class HashProviderCng : HashProvider
{
	...
	public override void Reset()
	{
		if (!_reusable || _running)
		{
			...
			SafeBCryptHashHandle phHash;
			global::Interop.BCrypt.NTSTATUS nTSTATUS = global::Interop.BCrypt.BCryptCreateHash(_hAlgorithm, out phHash, IntPtr.Zero, 0, _key, (_key != null) ? _key.Length : 0, dwFlags);
			if (nTSTATUS != 0)
			{
				throw global::Interop.BCrypt.CreateCryptographicException(nTSTATUS);
			}
