...
public sealed class DESCryptoServiceProvider : DES
{
	...
	private UniversalCryptoTransform CreateTransform(byte[] rgbKey, byte[] rgbIV, bool encrypting)
	{
		...
		BasicSymmetricCipher cipher = new BasicSymmetricCipherCsp(26113, Mode, BlockSize / 8, rgbKey, addNoSaltFlag: false, rgbIV, encrypting, FeedbackSize, this.GetPaddingSize(Mode, FeedbackSize));
