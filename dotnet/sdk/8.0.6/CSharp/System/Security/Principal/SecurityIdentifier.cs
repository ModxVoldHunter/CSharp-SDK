...
public sealed class SecurityIdentifier : IdentityReference, IComparable<SecurityIdentifier>
{
	...
	{
		ArgumentNullException.ThrowIfNull(sddlForm, "sddlForm");
		byte[] resultSid;
	...
	public SecurityIdentifier(WellKnownSidType sidType, SecurityIdentifier? domainSid)
	{
		...
		{
		case 87:
			throw new ArgumentException(Marshal.GetPInvokeErrorMessage(windowsAccountDomainSid), "sidType/domainSid");
		default:
			throw new Win32Exception(windowsAccountDomainSid);
		case 0:
	...
	private unsafe static IdentityReferenceCollection TranslateToNTAccounts(IdentityReferenceCollection sourceSids, out bool someFailed)
	{
		ArgumentNullException.ThrowIfNull(sourceSids, "sourceSids");
		if (sourceSids.Count == 0)
		{
			throw new ArgumentException(System.SR.Arg_EmptyCollection, "sourceSids");
		}
		nint[] array = new nint[sourceSids.Count];
		...
		try
		{
			...
			safeLsaPolicyHandle = Win32.LsaOpenPolicy(null, global::Interop.Advapi32.PolicyRights.POLICY_LOOKUP_NAMES);
			someFailed = false;
			...
			names.Initialize((uint)sourceSids.Count, (uint)sizeof(global::Interop.LSA_TRANSLATED_NAME));
			referencedDomains.InitializeReferencedDomainsList();
			...
			if (num2 == 0 || num2 == 263)
			{
				...
				{
					global::Interop.LSA_TRUST_INFORMATION* ptr = (global::Interop.LSA_TRUST_INFORMATION*)(lSA_REFERENCED_DOMAIN_LIST.Domains + (nint)i * (nint)sizeof(global::Interop.LSA_TRUST_INFORMATION));
					array3[i] = Marshal.PtrToStringUni(ptr->Name.Buffer, ptr->Name.Length / 2);
				}
