...
public sealed class NTAccount : IdentityReference
{
	...
	{
		ArgumentException.ThrowIfNullOrEmpty(accountName, "accountName");
	...
	{
		ArgumentNullException.ThrowIfNull(sourceAccounts, "sourceAccounts");
		if (targetType == typeof(SecurityIdentifier))
		{
	...
	private unsafe static IdentityReferenceCollection TranslateToSids(IdentityReferenceCollection sourceAccounts, out bool someFailed)
	{
		ArgumentNullException.ThrowIfNull(sourceAccounts, "sourceAccounts");
		...
		try
		{
			...
			if (num2 == 0 || num2 == 263)
			{
				sids.Initialize((uint)sourceAccounts.Count, (uint)sizeof(global::Interop.LSA_TRANSLATED_SID2));
