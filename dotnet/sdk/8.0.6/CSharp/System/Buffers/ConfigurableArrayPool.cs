...
internal sealed class ConfigurableArrayPool<T> : ArrayPool<T>
{
	...
	{
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(maxArrayLength, "maxArrayLength");
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(maxArraysPerBucket, "maxArraysPerBucket");
