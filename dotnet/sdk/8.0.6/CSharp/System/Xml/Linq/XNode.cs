...
public abstract class XNode : XObject
{
	...
	public static XNodeDocumentOrderComparer DocumentOrderComparer => s_documentOrderComparer ?? (s_documentOrderComparer = new XNodeDocumentOrderComparer());

	public static XNodeEqualityComparer EqualityComparer => s_equalityComparer ?? (s_equalityComparer = new XNodeEqualityComparer());
