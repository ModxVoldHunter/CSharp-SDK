...
internal static class XmlExceptionHelper
{
	...
	{
		ThrowXmlException(reader, System.SR.XmlMaxArrayLengthOrMaxItemsQuotaExceeded, maxQuota.ToString(NumberFormatInfo.CurrentInfo));
	}
	...
	{
		ThrowXmlException(reader, System.SR.XmlMaxNameTableCharCountExceeded, maxNameTableCharCount.ToString(NumberFormatInfo.CurrentInfo));
	}
