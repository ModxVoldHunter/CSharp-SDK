...
internal sealed class SortAction : CompiledAction
{
	...
	private string ParseLang(string value)
	{
		...
		if (!XmlComplianceUtil.IsValidLanguageID(value) && (value.Length == 0 || cultureInfo == null))
		{
