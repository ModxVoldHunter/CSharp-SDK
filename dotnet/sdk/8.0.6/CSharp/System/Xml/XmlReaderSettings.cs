...
public sealed class XmlReaderSettings
{
	...
	public XmlSchemaSet Schemas
	{
		get
		{
			return _schemas ?? (_schemas = new XmlSchemaSet());
		}
		set
		{
	...
	{
		XmlReaderSettings xmlReaderSettings = (XmlReaderSettings)MemberwiseClone();
	...
	internal XmlReader CreateReader(string inputUri, XmlParserContext inputContext)
	{
		...
		XmlResolver uriResolver = GetXmlResolver() ?? GetDefaultPermissiveResolver();
	...
	internal XmlReader AddValidation(XmlReader reader)
	{
		...
		if (_validationType == ValidationType.Schema)
		{
			...
			{
				xmlResolver = GetDefaultPermissiveResolver();
			}
		}
	...
	{
		if (!LocalAppContextSwitches.IsNetworkingEnabledByDefault)
		{
			return System.Xml.XmlResolver.FileSystemResolver;
		}
