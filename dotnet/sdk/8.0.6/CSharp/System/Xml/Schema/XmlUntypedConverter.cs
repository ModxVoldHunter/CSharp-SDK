...
internal sealed class XmlUntypedConverter : XmlListConverter
{
	...
	private XmlUntypedConverter(XmlUntypedConverter atomicConverter, bool allowListToList)
		: base(atomicConverter, allowListToList ? XmlBaseConverter.StringArrayType : XmlBaseConverter.StringType, allowListToList ? XmlBaseConverter.StringArrayArrayType : XmlBaseConverter.StringArrayType)
	{
