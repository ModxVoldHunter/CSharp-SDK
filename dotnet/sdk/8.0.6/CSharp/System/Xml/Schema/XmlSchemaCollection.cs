...
public sealed class XmlSchemaCollection : ICollection, IEnumerable
{
	...
	public XmlSchema? this[string? ns] => ((XmlSchemaCollectionNode)_collection[ns ?? string.Empty])?.Schema;
	...
	void ICollection.CopyTo(Array array, int index)
	{
		...
		while (enumerator.MoveNext())
		{
			ArgumentOutOfRangeException.ThrowIfEqual(index, array.Length, "index");
	...
	{
		return ((XmlSchemaCollectionNode)_collection[ns ?? string.Empty])?.SchemaInfo;
	}
