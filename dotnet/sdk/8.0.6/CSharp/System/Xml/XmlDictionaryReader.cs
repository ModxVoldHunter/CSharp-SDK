...
public abstract class XmlDictionaryReader : XmlReader
{
	private sealed class XmlWrappedReader : XmlDictionaryReader, IXmlLineInfo
	{
		...
		public override bool ReadContentAsBoolean()
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException("Boolean", exception);
			}
			catch (FormatException exception2)
			{
				throw XmlExceptionHelper.CreateConversionException("Boolean", exception2);
			}
		}
		...
		public override decimal ReadContentAsDecimal()
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException("Decimal", exception);
			}
			catch (FormatException exception2)
			{
				throw XmlExceptionHelper.CreateConversionException("Decimal", exception2);
			}
			catch (OverflowException exception3)
			{
				throw XmlExceptionHelper.CreateConversionException("Decimal", exception3);
			}
		}
		...
		public override double ReadContentAsDouble()
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException("Double", exception);
			}
			catch (FormatException exception2)
			{
				throw XmlExceptionHelper.CreateConversionException("Double", exception2);
			}
			catch (OverflowException exception3)
			{
				throw XmlExceptionHelper.CreateConversionException("Double", exception3);
			}
		}
		...
		public override int ReadContentAsInt()
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException("Int32", exception);
			}
			catch (FormatException exception2)
			{
				throw XmlExceptionHelper.CreateConversionException("Int32", exception2);
			}
			catch (OverflowException exception3)
			{
				throw XmlExceptionHelper.CreateConversionException("Int32", exception3);
			}
		}
		...
		public override long ReadContentAsLong()
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException("Int64", exception);
			}
			catch (FormatException exception2)
			{
				throw XmlExceptionHelper.CreateConversionException("Int64", exception2);
			}
			catch (OverflowException exception3)
			{
				throw XmlExceptionHelper.CreateConversionException("Int64", exception3);
			}
		}
		...
		public override float ReadContentAsFloat()
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException("Single", exception);
			}
			catch (FormatException exception2)
			{
				throw XmlExceptionHelper.CreateConversionException("Single", exception2);
			}
			catch (OverflowException exception3)
			{
				throw XmlExceptionHelper.CreateConversionException("Single", exception3);
			}
		}
		...
		public override string ReadContentAsString()
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException("String", exception);
			}
			catch (FormatException exception2)
			{
				throw XmlExceptionHelper.CreateConversionException("String", exception2);
			}
		}
	...
	{
		ArgumentNullException.ThrowIfNull(namespaceUri, "namespaceUri");
	...
	{
		ArgumentNullException.ThrowIfNull(localNames, "localNames");
		ArgumentNullException.ThrowIfNull(namespaceUri, "namespaceUri");
	...
	protected string ReadString(int maxStringContentLength)
	{
		...
		if (NodeType == XmlNodeType.Element)
		{
			...
			if (!Read())
			{
				throw new InvalidOperationException(System.SR.XmlInvalidOperation);
			}
	...
	{
		ArgumentNullException.ThrowIfNull(strings, "strings");
	...
	public override DateTime ReadElementContentAsDateTime()
	{
		...
		if (IsStartElement() && IsEmptyElement)
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException(string.Empty, "DateTime", exception2);
			}
		}
		else
		{
	...
	public virtual UniqueId ReadElementContentAsUniqueId()
	{
		...
		if (IsStartElement() && IsEmptyElement)
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException(string.Empty, "UniqueId", exception2);
			}
		}
		else
		{
	...
	public virtual Guid ReadElementContentAsGuid()
	{
		...
		if (IsStartElement() && IsEmptyElement)
		{
			...
			{
				throw XmlExceptionHelper.CreateConversionException(string.Empty, "Guid", exception2);
			}
			catch (OverflowException exception3)
			{
				throw XmlExceptionHelper.CreateConversionException(string.Empty, "Guid", exception3);
			}
		}
		else
		{
