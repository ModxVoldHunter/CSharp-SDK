		...
		if (typeof(XmlSchemaType).IsAssignableFrom(type))
		{
			...
			if (item is XmlSchemaComplexType xmlSchemaComplexType)
			{
				if (xmlSchemaComplexType.ContentModel != null)
				{
					...
					else if (content is XmlSchemaSimpleContentRestriction xmlSchemaSimpleContentRestriction)
					{
					...
					else if (content is XmlSchemaComplexContentExtension xmlSchemaComplexContentExtension)
					{
			...
			else if (item is XmlSchemaSimpleType xmlSchemaSimpleType)
			{
				...
				else if (content2 is XmlSchemaSimpleTypeList xmlSchemaSimpleTypeList)
				{
