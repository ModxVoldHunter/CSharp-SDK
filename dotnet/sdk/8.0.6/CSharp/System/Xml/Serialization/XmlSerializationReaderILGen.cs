...
internal sealed class XmlSerializationReaderILGen : XmlSerializationILGen
{
		...
		internal Member(string source, string arraySource, string arrayName, int i, MemberMapping mapping, bool multiRef, string choiceSource)
		{
			...
			if (mapping.TypeDesc.IsArrayLike)
			{
				...
				if (mapping.ChoiceIdentifier != null)
				{
					...
					handler = new DefaultInterpolatedStringHandler(26, 5);
					handler.AppendFormatted(choiceArrayName);
					handler.AppendLiteral(" = ");
					handler.AppendFormatted(value);
					handler.AppendLiteral("EnsureArrayIndex(");
					handler.AppendFormatted(choiceArrayName);
					handler.AppendLiteral(", ");
					handler.AppendFormatted(text);
					handler.AppendLiteral(", ");
					handler.AppendFormatted(ReflectionAwareILGen.GetStringForTypeof(cSharpName));
					handler.AppendLiteral(");");
					string text2 = handler.ToStringAndClear();
	...
	internal Dictionary<string, EnumMapping> Enums => _enums ?? (_enums = new Dictionary<string, EnumMapping>());
	...
	private static Regex EnsureArrayIndexRegex()
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__EnsureArrayIndexRegex_5.Instance;
	}

	[GeneratedRegex("(?<a>[^[]+)[[](?<ia>.+)[]]")]
	[GeneratedCode("System.Text.RegularExpressions.Generator", "8.0.10.26715")]
	private static Regex P0Regex()
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__P0Regex_6.Instance;
	}
	...
	private void WriteSourceEnd(string source, Type elementType, Type stackType)
	{
		...
		if (match.Success)
		{
			...
			Type elementType2 = CodeGenerator.GetVariableType(variable2).GetElementType();
		...
		else
		{
			...
			Type variableType2 = CodeGenerator.GetVariableType(ilg.GetVariable(match.Groups["a"].Value));
	...
	[GeneratedCode("System.Text.RegularExpressions.Generator", "8.0.10.26715")]
	private static Regex UnknownNodeNullAnyTypeRegex()
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__UnknownNodeNullAnyTypeRegex_7.Instance;
	}

	[GeneratedRegex("UnknownNode[(][(]object[)](?<o>[^,]+), @[\"](?<qnames>[^\"]*)[\"][)];")]
	[GeneratedCode("System.Text.RegularExpressions.Generator", "8.0.10.26715")]
	private static Regex UnknownNodeObjectEmptyRegex()
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__UnknownNodeObjectEmptyRegex_8.Instance;
	}

	[GeneratedRegex("UnknownNode[(][(]object[)](?<o>[^,]+), null[)];")]
	[GeneratedCode("System.Text.RegularExpressions.Generator", "8.0.10.26715")]
	private static Regex UnknownNodeObjectNullRegex()
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__UnknownNodeObjectNullRegex_9.Instance;
	}

	[GeneratedRegex("UnknownNode[(][(]object[)](?<o>[^)]+)[)];")]
	[GeneratedCode("System.Text.RegularExpressions.Generator", "8.0.10.26715")]
	private static Regex UnknownNodeObjectRegex()
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__UnknownNodeObjectRegex_10.Instance;
	}

	[GeneratedRegex("paramsRead\\[(?<index>[0-9]+)\\]")]
	[GeneratedCode("System.Text.RegularExpressions.Generator", "8.0.10.26715")]
	private static Regex ParamsReadRegex()
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__ParamsReadRegex_11.Instance;
	}
