...
internal sealed class XmlBufferReader
{
	...
	private bool TryEnsureBytes(int count)
	{
		...
		do
		{
			...
			num2 = num - _offsetMax;
			num3 = _stream.ReadAtLeast(_buffer.AsSpan(_offsetMax, num2), num2, throwOnEndOfStream: false);
			_offsetMax += num3;
		}
		while (num3 >= num2);
		return false;
	...
	public int ReadUInt16()
	{
		...
		{
			return BinaryPrimitives.ReverseEndianness(ReadRawBytes<ushort>());
		}
		return ReadRawBytes<ushort>();
	}
	...
	public int ReadInt32()
	{
		if (!BitConverter.IsLittleEndian)
		{
			return BinaryPrimitives.ReverseEndianness(ReadRawBytes<int>());
		}
		return ReadRawBytes<int>();
	}
	...
	public long ReadInt64()
	{
		if (!BitConverter.IsLittleEndian)
		{
			return BinaryPrimitives.ReverseEndianness(ReadRawBytes<long>());
		}
		return ReadRawBytes<long>();
	}

	public float ReadSingle()
	{
		int offset;
		float result = BinaryPrimitives.ReadSingleLittleEndian(GetBuffer(4, out offset).AsSpan(offset, 4));
		Advance(4);
		return result;
	}
	...
	{
		int offset;
		double result = BinaryPrimitives.ReadDoubleLittleEndian(GetBuffer(8, out offset).AsSpan(offset, 8));
		Advance(8);
		return result;
	}
	...
	public decimal ReadDecimal()
	{
		...
		ReadOnlySpan<byte> readOnlySpan = buffer.AsSpan(offset, 16);
		Span<int> span = stackalloc int[4]
		{
			BinaryPrimitives.ReadInt32LittleEndian(readOnlySpan.Slice(8, 4)),
			BinaryPrimitives.ReadInt32LittleEndian(readOnlySpan.Slice(12, 4)),
			BinaryPrimitives.ReadInt32LittleEndian(readOnlySpan.Slice(4, 4)),
			BinaryPrimitives.ReadInt32LittleEndian(readOnlySpan.Slice(0, 4))
		};
		ReadOnlySpan<int> bits = span;
		Advance(16);
	...
	public DateTime ReadDateTime()
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(dateData.ToString(CultureInfo.InvariantCulture), "DateTime", exception);
		}
		catch (FormatException exception2)
		{
			throw XmlExceptionHelper.CreateConversionException(dateData.ToString(CultureInfo.InvariantCulture), "DateTime", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(dateData.ToString(CultureInfo.InvariantCulture), "DateTime", exception3);
		}
	}
	...
	public TimeSpan ReadTimeSpan()
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value.ToString(CultureInfo.InvariantCulture), "TimeSpan", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(value.ToString(CultureInfo.InvariantCulture), "TimeSpan", exception3);
		}
	}
	...
	public bool IsWhitespaceKey(int key)
	{
		...
		return XmlConverter.IsWhitespace(value);
	}
	...
	{
		int offset;
		ReadOnlySpan<byte> source = GetBuffer(sizeof(T), out offset).AsSpan(offset, sizeof(T));
	...
	{
		return MemoryMarshal.Read<T>(_buffer.AsSpan(offset, sizeof(T)));
	}
	...
	public int GetInt16(int offset)
	{
		if (!BitConverter.IsLittleEndian)
		{
			return BinaryPrimitives.ReverseEndianness(ReadRawBytes<short>(offset));
		}
		return ReadRawBytes<short>(offset);
	}
	...
	public int GetInt32(int offset)
	{
		if (!BitConverter.IsLittleEndian)
		{
			return BinaryPrimitives.ReverseEndianness(ReadRawBytes<int>(offset));
		}
		return ReadRawBytes<int>(offset);
	}
	...
	public long GetInt64(int offset)
	{
		if (!BitConverter.IsLittleEndian)
		{
			return BinaryPrimitives.ReverseEndianness(ReadRawBytes<long>(offset));
		}
		return ReadRawBytes<long>(offset);
	}
	...
	{
		return BinaryPrimitives.ReadSingleLittleEndian(_buffer.AsSpan(offset, 4));
	}

	public double GetDouble(int offset)
	{
		return BinaryPrimitives.ReadDoubleLittleEndian(_buffer.AsSpan(offset, 8));
	}
	...
	public decimal GetDecimal(int offset)
	{
		...
		ReadOnlySpan<byte> readOnlySpan = _buffer.AsSpan(offset, 16);
		Span<int> span = stackalloc int[4]
		{
			BinaryPrimitives.ReadInt32LittleEndian(readOnlySpan.Slice(8, 4)),
			BinaryPrimitives.ReadInt32LittleEndian(readOnlySpan.Slice(12, 4)),
	...
	{
		return new Guid(_buffer.AsSpan(offset, 16));
	}
	...
	public int ReadDictionaryKey()
	{
		...
		if (((uint)num & (true ? 1u : 0u)) != 0)
		{
			...
			int num2 = num >> 1;
			if (!_session.TryLookup(num2, out result))
			{
		...
		else
		{
			...
			int num3 = num >> 1;
			if (!_dictionary.TryLookup(num3, out result))
			{
