...
public class IsolatedStorageFileStream : FileStream
{
	...
	public override nint Handle => _fs.Handle;
	...
	private static InitializationData InitializeFileStream(string path, FileMode mode, FileAccess access, FileShare share, int bufferSize, IsolatedStorageFile isf)
	{
		...
		InitializationData initializationData = default(InitializationData);
		initializationData.FullPath = isf.GetFullPath(path);
		initializationData.StorageFile = isf;
