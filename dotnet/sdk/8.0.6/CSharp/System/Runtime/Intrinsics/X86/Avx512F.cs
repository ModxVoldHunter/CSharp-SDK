...
public abstract class Avx512F : Avx2
{
	...
	public abstract class VL
	{
		...
		{
			return AlignRight32(left, right, mask);
		}
		...
		{
			return AlignRight64(left, right, mask);
		}
		...
		{
			return ConvertToVector128Int16WithSaturation(value);
		}
		...
		{
			return ConvertToVector128Int32WithSaturation(value);
		}
		...
		{
			return ConvertToVector128UInt16(value);
		}
		...
		{
			return ConvertToVector128UInt16WithSaturation(value);
		}
		...
		{
			return ConvertToVector128UInt32(value);
		}
		...
		{
			return ConvertToVector128UInt32WithSaturation(value);
		}
		...
		{
			return ConvertToVector128UInt32WithTruncation(value);
		}
		...
		{
			return Fixup(left, right, table, control);
		}
		...
		{
			return GetMantissa(value, control);
		}
		...
		{
			return PermuteVar2x64x2(lower, indices, upper);
		}
		...
		{
			return PermuteVar4x32x2(lower, indices, upper);
		}
		...
		{
			return PermuteVar4x64(value, control);
		}
		...
		{
			return PermuteVar4x64x2(lower, indices, upper);
		}
		...
		{
			return PermuteVar8x32x2(lower, indices, upper);
		}
		...
		{
			return RotateLeftVariable(value, count);
		}
		...
		{
			return RotateRightVariable(value, count);
		}
		...
		{
			return RoundScale(value, control);
		}
		...
		{
			return Shuffle2x128(left, right, control);
		}
		...
		{
			return TernaryLogic(a, b, c, control);
		}
	...
	public new abstract class X64 : Avx2.X64
	{
		...
		{
			return ConvertToUInt64WithTruncation(value);
		}
	...
	{
		return ConvertToUInt32WithTruncation(value);
	}
	...
	{
		return ConvertToVector256Int16WithSaturation(value);
	}
	...
	{
		return ConvertToVector256Int32WithSaturation(value);
	}
	...
	{
		return ConvertToVector256UInt16(value);
	}
	...
	{
		return ConvertToVector256UInt16WithSaturation(value);
	}
	...
	{
		return ConvertToVector256UInt32WithSaturation(value);
	}
	...
	{
		return ConvertToVector512Int32(value);
	}
	...
	{
		return ConvertToVector512Int32WithTruncation(value);
	}
	...
	{
		return ConvertToVector512Single(value);
	}
	...
	{
		return ConvertToVector512UInt32(value);
	}
	...
	{
		return ConvertToVector512UInt32WithTruncation(value);
	}
	...
	{
		return FixupScalar(left, right, table, control);
	}
	...
	{
		return FusedMultiplyAddSubtract(a, b, c);
	}
	...
	{
		return FusedMultiplySubtract(a, b, c);
	}
	...
	{
		return FusedMultiplySubtractAdd(a, b, c);
	}
	...
	{
		return FusedMultiplyAddNegated(a, b, c);
	}
	...
	{
		return FusedMultiplySubtractNegated(a, b, c);
	}
	...
	{
		return GetExponentScalar(value);
	}
	...
	{
		return GetExponentScalar(upper, value);
	}
	...
	{
		return GetMantissaScalar(value, control);
	}
	...
	{
		return GetMantissaScalar(upper, value, control);
	}
	...
	{
		return LoadAlignedVector512(address);
	}
	...
	{
		return LoadAlignedVector512NonTemporal(address);
	}
	...
	{
		return PermuteVar8x64x2(lower, indices, upper);
	}
	...
	{
		return PermuteVar16x32(left, control);
	}
	...
	{
		return PermuteVar16x32x2(lower, indices, upper);
	}
	...
	{
		return Reciprocal14Scalar(value);
	}
	...
	{
		return Reciprocal14Scalar(upper, value);
	}
	...
	{
		return ReciprocalSqrt14Scalar(value);
	}
	...
	{
		return ReciprocalSqrt14Scalar(upper, value);
	}
	...
	{
		return RoundScaleScalar(value, control);
	}
	...
	{
		return RoundScaleScalar(upper, value, control);
	}
	...
	{
		return Shuffle4x128(left, right, control);
	}
