...
internal sealed class XmlSerializableWriter : XmlWriter
{
	...
	internal void EndWrite()
	{
		if (_depth != 0)
		{
			throw XmlObjectSerializer.CreateSerializationException(System.SR.Format(System.SR.IXmlSerializableMissingEndElements, (_obj == null) ? string.Empty : DataContract.GetClrTypeFullName(_obj.GetType())));
		}
		_obj = null;
	}
	...
	public override void WriteEndElement()
	{
		if (_depth == 0)
		{
			throw XmlObjectSerializer.CreateSerializationException(System.SR.Format(System.SR.IXmlSerializableWritePastSubTree, (_obj == null) ? string.Empty : DataContract.GetClrTypeFullName(_obj.GetType())));
		}
	...
	{
		throw XmlObjectSerializer.CreateSerializationException(System.SR.IXmlSerializableIllegalOperation);
	}
