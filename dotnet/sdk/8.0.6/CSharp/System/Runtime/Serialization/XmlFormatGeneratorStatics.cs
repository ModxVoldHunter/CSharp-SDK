...
internal static class XmlFormatGeneratorStatics
{
	...
	internal static ConstructorInfo SerializationExceptionCtor => s_serializationExceptionCtor ?? (s_serializationExceptionCtor = typeof(SerializationException).GetConstructor(new Type[1] { typeof(string) }));
	...
	internal static MethodInfo ReplaceDeserializedObjectMethod
	{
		get
		{
			...
			{
				s_replaceDeserializedObjectMethod = typeof(XmlObjectSerializerReadContext).GetMethod("ReplaceDeserializedObject", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
			}
	...
	internal static MethodInfo WriteExtensionDataMethod
	{
		...
		get
		{
			return s_writeExtensionDataMethod ?? (s_writeExtensionDataMethod = typeof(XmlObjectSerializerWriteContext).GetMethod("WriteExtensionData", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic));
		}
	}
