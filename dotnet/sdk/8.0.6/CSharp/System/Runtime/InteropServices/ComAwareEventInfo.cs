...
public class ComAwareEventInfo : EventInfo
{
	...
	private static void GetDataForComInvocation(EventInfo eventInfo, out Guid sourceIid, out int dispid)
	{
		...
		ComEventInterfaceAttribute comEventInterfaceAttribute = (ComEventInterfaceAttribute)customAttributes[0];
		if (customAttributes.Length > 1)
		{
			throw new AmbiguousMatchException(System.SR.Format(System.SR.AmbiguousMatch_MultipleEventInterfaceAttributes, comEventInterfaceAttribute));
		}
		Type sourceInterface = comEventInterfaceAttribute.SourceInterface;
