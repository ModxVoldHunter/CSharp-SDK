...
internal sealed class SecurityPackageInfoClass
{
	...
	internal unsafe SecurityPackageInfoClass(SafeHandle safeHandle, int index)
	{
		...
		nint num = safeHandle.DangerousGetHandle() + sizeof(SecurityPackageInfo) * index;
		if (System.Net.NetEventSource.Log.IsEnabled())
		{
			System.Net.NetEventSource.Info(this, $"unmanagedAddress: {num}", ".ctor");
		}
		SecurityPackageInfo* ptr = (SecurityPackageInfo*)num;
