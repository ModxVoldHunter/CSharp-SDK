...
public sealed class HttpListenerContext
{
	...
	[CompilerGenerated]
	private ExtendedProtectionPolicy _003CExtendedProtectionPolicy_003Ek__BackingField;
	...
	public HttpListenerResponse Response => _response ?? (_response = new HttpListenerResponse(this));
	...
	internal ExtendedProtectionPolicy ExtendedProtectionPolicy
	{
		...
		set
		{
			_003CExtendedProtectionPolicy_003Ek__BackingField = value;
		}
	}
	...
	internal unsafe HttpListenerContext(HttpListenerSession session, RequestContextBase memoryBlob)
	{
		...
		{
			System.Net.NetEventSource.Info(this, $"httpListener {session.Listener} requestBlob={(nint)memoryBlob.RequestBlob}", ".ctor");
		}
	...
	internal void SetIdentity(IPrincipal principal, string mutualAuthentication)
	{
		...
		if (System.Net.NetEventSource.Log.IsEnabled())
		{
			System.Net.NetEventSource.Info(this, FormattableStringFactory.Create("mutual: {0}, Principal: {1}", mutualAuthentication ?? "<null>", principal), "SetIdentity");
		}
	}
