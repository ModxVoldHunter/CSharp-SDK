...
public abstract class WebRequest : MarshalByRefObject, ISerializable
{
	...
	{
		ArgumentNullException.ThrowIfNull(requestUriString, "requestUriString");
	...
	{
		ArgumentNullException.ThrowIfNull(requestUri, "requestUri");
	...
	public virtual async Task<Stream> GetRequestStreamAsync()
	{
		...
		return await Task<Stream>.Factory.FromAsync((AsyncCallback callback, object state) => ((WebRequest)state).BeginGetRequestStream(callback, state), (IAsyncResult iar) => ((WebRequest)iar.AsyncState).EndGetRequestStream(iar), this).ConfigureAwait(continueOnCapturedContext: false);
	}

	public virtual async Task<WebResponse> GetResponseAsync()
	{
		await Task.CompletedTask.ConfigureAwait(ConfigureAwaitOptions.ForceYielding);
		return await Task<WebResponse>.Factory.FromAsync((AsyncCallback callback, object state) => ((WebRequest)state).BeginGetResponse(callback, state), (IAsyncResult iar) => ((WebRequest)iar.AsyncState).EndGetResponse(iar), this).ConfigureAwait(continueOnCapturedContext: false);
	}
