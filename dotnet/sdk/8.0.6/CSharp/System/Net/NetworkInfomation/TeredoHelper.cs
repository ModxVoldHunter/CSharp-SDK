...
internal sealed class TeredoHelper
{
	...
	public unsafe static bool UnsafeNotifyStableUnicastIpAddressTable(Action<object> callback, object state)
	{
		...
		try
		{
			...
			uint num = global::Interop.IpHlpApi.NotifyStableUnicastIpAddressTable(AddressFamily.Unspecified, out table, (delegate* unmanaged<nint, nint, void>)(delegate*<nint, nint, void>)(&OnStabilized), GCHandle.ToIntPtr(teredoHelper._gcHandle), out teredoHelper._cancelHandle);
			table.Dispose();
			switch (num)
			{
			case 997u:
	...
	private static void OnStabilized(nint context, nint table)
	{
