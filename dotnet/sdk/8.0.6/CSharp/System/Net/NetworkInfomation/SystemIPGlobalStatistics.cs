...
internal sealed class SystemIPGlobalStatistics : IPGlobalStatistics
{
	...
	public override bool ForwardingEnabled => _stats.forwardingEnabled != 0;
	...
	{
		fixed (global::Interop.IpHlpApi.MibIpStats* statistics = &_stats)
		{
			uint ipStatisticsEx = global::Interop.IpHlpApi.GetIpStatisticsEx(statistics, family);
			if (ipStatisticsEx != 0)
			{
