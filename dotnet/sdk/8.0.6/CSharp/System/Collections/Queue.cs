...
public class Queue : ICollection, IEnumerable, ICloneable
{
	...
	public Queue(int capacity, float growFactor)
	{
		...
		ArgumentOutOfRangeException.ThrowIfLessThan(growFactor, 1f, "growFactor");
		ArgumentOutOfRangeException.ThrowIfGreaterThan(growFactor, 10f, "growFactor");
