...
public class BlockingCollection<T> : IEnumerable<T>, IEnumerable, ICollection, IDisposable, IReadOnlyCollection<T>
{
	...
	public BlockingCollection(IProducerConsumerCollection<T> collection, int boundedCapacity)
	{
		...
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(boundedCapacity, "boundedCapacity");
	...
	public IEnumerable<T> GetConsumingEnumerable(CancellationToken cancellationToken)
	{
		...
		T item;
		while (TryTakeWithNoTimeValidation(out item, -1, cancellationToken, linkedTokenSource))
		{
			yield return item;
		}
	}
	...
	{
		ArgumentNullException.ThrowIfNull(collections, "collections");
