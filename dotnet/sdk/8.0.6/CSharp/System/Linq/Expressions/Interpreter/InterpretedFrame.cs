...
internal sealed class InterpretedFrame
{
	...
	internal void SaveTraceToException(Exception exception)
	{
		...
		object typeFromHandle = typeof(InterpretedFrameInfo);
		if (data[typeFromHandle] == null)
		{
			object obj = (data[typeFromHandle] = new List<InterpretedFrameInfo>(GetStackTraceDebugInfo()).ToArray());
		}
	}
