...
internal sealed class LightCompiler
{
	...
	[UnconditionalSuppressMessage("DynamicDependency", "IL3050", Justification = "NewArrayExpression has RequiresDynamicCode, so the only way to get here is by already seeing a warning.")]
