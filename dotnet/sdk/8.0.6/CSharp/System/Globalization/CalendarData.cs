...
internal sealed class CalendarData
{
	...
	{
		return Interop.Globalization.EnumCalendarInfo((delegate* unmanaged<char*, nint, void>)(delegate*<char*, nint, void>)(&EnumCalendarInfoCallback), localeName, calendarId, dataType, (nint)Unsafe.AsPointer(ref callbackContext));
	}
	...
	private unsafe static bool CallEnumCalendarInfo(string localeName, CalendarId calendar, uint calType, uint lcType, out string[] data)
	{
		...
		Interop.Kernel32.EnumCalendarInfoExEx((delegate* unmanaged<char*, uint, nint, void*, Interop.BOOL>)(delegate*<char*, uint, nint, void*, Interop.BOOL>)(&EnumCalendarInfoCallback), localeName, (uint)calendar, null, calType, &enumData);
	...
	{
		NlsEnumCalendarsData nlsEnumCalendarsData = default(NlsEnumCalendarsData);
		...
		Interop.Kernel32.EnumCalendarInfoExEx((delegate* unmanaged<char*, uint, nint, void*, Interop.BOOL>)(delegate*<char*, uint, nint, void*, Interop.BOOL>)(&EnumCalendarsCallback), localeName, uint.MaxValue, null, 1u, &nlsEnumCalendarsData);
