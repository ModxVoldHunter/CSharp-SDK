...
internal sealed class XmlObjectSerializerReadContextComplexJson : XmlObjectSerializerReadContextComplex
{
	...
	protected override IDataNode ReadPrimitiveExtensionDataValue(XmlReaderDelegator xmlReader, string dataContractName, string dataContractNamespace)
	{
		...
		case "number":
			...
			break;
		default:
			throw XmlObjectSerializer.CreateSerializationException(System.SR.Format(System.SR.JsonUnexpectedAttributeValue, _extensionDataValueType));
		}
	...
	{
		throw new SerializationException(System.SR.Format(System.SR.JsonDuplicateMemberInInput, DataContract.GetClrTypeFullName(obj.GetType()), memberNames[memberIndex]));
	}
	...
	public static void ThrowMissingRequiredMembers(object obj, XmlDictionaryString[] memberNames, byte[] expectedElements, byte[] requiredElements)
	{
		...
		if (num == 1)
		{
			throw new SerializationException(System.SR.Format(System.SR.JsonOneRequiredMemberNotFound, DataContract.GetClrTypeFullName(obj.GetType()), stringBuilder.ToString()));
		}
		throw new SerializationException(System.SR.Format(System.SR.JsonRequiredMembersNotFound, DataContract.GetClrTypeFullName(obj.GetType()), stringBuilder.ToString()));
	}
