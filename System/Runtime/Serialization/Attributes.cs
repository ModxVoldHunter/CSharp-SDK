...
internal sealed class Attributes
{
	...
	private void ReadId(XmlReaderDelegator reader)
	{
		...
		{
			throw XmlObjectSerializer.CreateSerializationException(System.SR.Format(System.SR.InvalidXsIdDefinition, Id));
		}
	}
	...
	private void ReadRef(XmlReaderDelegator reader)
	{
		...
		{
			throw XmlObjectSerializer.CreateSerializationException(System.SR.Format(System.SR.InvalidXsRefDefinition, Ref));
		}
	}
	...
	private void ReadArraySize(XmlReaderDelegator reader)
	{
		...
		if (ArraySZSize < 0)
		{
			throw XmlObjectSerializer.CreateSerializationException(System.SR.Format(System.SR.InvalidSizeDefinition, ArraySZSize));
		}
	}
