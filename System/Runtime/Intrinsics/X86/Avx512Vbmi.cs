...
public abstract class Avx512Vbmi : Avx512BW
{
	...
	public new abstract class VL : Avx512BW.VL
	{
		...
		{
			return PermuteVar16x8(left, control);
		}
		...
		{
			return PermuteVar16x8x2(lower, indices, upper);
		}
		...
		{
			return PermuteVar32x8(left, control);
		}
		...
		{
			return PermuteVar32x8x2(lower, indices, upper);
		}
	...
	{
		return PermuteVar64x8(left, control);
	}
	...
	{
		return PermuteVar64x8x2(lower, indices, upper);
	}
