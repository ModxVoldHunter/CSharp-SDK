...
public abstract class PackedSimd
{
	...
	public static nint ExtractScalar(Vector128<nint> value, [ConstantExpected(Max = 3)] byte index)
	{
		throw new PlatformNotSupportedException();
	}

	public static nuint ExtractScalar(Vector128<nuint> value, [ConstantExpected(Max = 3)] byte index)
	{
		throw new PlatformNotSupportedException();
	}
	...
	public static Vector128<nint> ReplaceScalar(Vector128<nint> vector, [ConstantExpected(Max = 3)] byte imm, nint value)
	{
		throw new PlatformNotSupportedException();
	}

	public static Vector128<nuint> ReplaceScalar(Vector128<nuint> vector, [ConstantExpected(Max = 3)] byte imm, nuint value)
	{
		throw new PlatformNotSupportedException();
	}
	...
	public unsafe static Vector128<nint> LoadVector128(nint* address)
	{
		throw new PlatformNotSupportedException();
	}

	public unsafe static Vector128<nuint> LoadVector128(nuint* address)
	{
		throw new PlatformNotSupportedException();
	}
	...
	public unsafe static Vector128<nint> LoadScalarVector128(nint* address)
	{
		throw new PlatformNotSupportedException();
	}

	public unsafe static Vector128<nuint> LoadScalarVector128(nuint* address)
	{
		throw new PlatformNotSupportedException();
	}
	...
	public unsafe static Vector128<nint> LoadScalarAndSplatVector128(nint* address)
	{
		throw new PlatformNotSupportedException();
	}

	public unsafe static Vector128<nuint> LoadScalarAndSplatVector128(nuint* address)
	{
		throw new PlatformNotSupportedException();
	}
	...
	public unsafe static Vector128<nint> LoadScalarAndInsert(nint* address, Vector128<nint> vector, [ConstantExpected(Max = 3)] byte index)
	{
		throw new PlatformNotSupportedException();
	}

	public unsafe static Vector128<nuint> LoadScalarAndInsert(nuint* address, Vector128<nuint> vector, [ConstantExpected(Max = 3)] byte index)
	{
		throw new PlatformNotSupportedException();
	}
	...
	public unsafe static void Store(nint* address, Vector128<nint> source)
	{
		throw new PlatformNotSupportedException();
	}

	public unsafe static void Store(nuint* address, Vector128<nuint> source)
	{
		throw new PlatformNotSupportedException();
	}
	...
	public unsafe static void StoreSelectedScalar(nint* address, Vector128<nint> source, [ConstantExpected(Max = 3)] byte index)
	{
		throw new PlatformNotSupportedException();
	}

	public unsafe static void StoreSelectedScalar(nuint* address, Vector128<nuint> source, [ConstantExpected(Max = 3)] byte index)
	{
		throw new PlatformNotSupportedException();
	}
