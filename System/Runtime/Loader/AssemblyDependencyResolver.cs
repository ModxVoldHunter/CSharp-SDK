...
public sealed class AssemblyDependencyResolver
{
	...
	public AssemblyDependencyResolver(string componentAssemblyPath)
	{
		...
		try
		{
			...
			nint functionPointerForDelegate = Marshal.GetFunctionPointerForDelegate(corehost_error_writer_fn);
			nint errorWriter = Interop.HostPolicy.corehost_set_error_writer(functionPointerForDelegate);
			try
			{
