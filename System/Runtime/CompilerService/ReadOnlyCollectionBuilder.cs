...
public sealed class ReadOnlyCollectionBuilder<T> : IList<T>, ICollection<T>, IEnumerable<T>, IEnumerable, IList, ICollection
{
	...
	public int Capacity
	{
		...
		set
		{
			ArgumentOutOfRangeException.ThrowIfLessThan(value, _size, "value");
	...
	public T this[int index]
	{
		get
		{
			ArgumentOutOfRangeException.ThrowIfGreaterThanOrEqual(index, _size, "index");
			return _items[index];
		}
		set
		{
	...
	{
		ArgumentOutOfRangeException.ThrowIfGreaterThan(index, _size, "index");
