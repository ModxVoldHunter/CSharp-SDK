...
public struct HashCode
{
	...
	public void AddBytes(ReadOnlySpan<byte> value)
	{
		...
		if (value.Length >= 16)
		{
			...
			ref byte right = ref Unsafe.Subtract(ref reference2, Unsafe.ByteOffset(ref reference, ref reference2) % 16);
			while (Unsafe.IsAddressLessThan(ref reference, ref right))
			{
				uint input = Unsafe.ReadUnaligned<uint>(ref reference);
				_v1 = Round(_v1, input);
				uint input2 = Unsafe.ReadUnaligned<uint>(ref Unsafe.Add(ref reference, 4));
				_v2 = Round(_v2, input2);
				uint input3 = Unsafe.ReadUnaligned<uint>(ref Unsafe.Add(ref reference, 8));
				_v3 = Round(_v3, input3);
				uint input4 = Unsafe.ReadUnaligned<uint>(ref Unsafe.Add(ref reference, 12));
				_v4 = Round(_v4, input4);
				_length += 4u;
