...
public static class ParallelEnumerable
{
	...
	{
		ArgumentNullException.ThrowIfNull(source, "source");
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(degreeOfParallelism, "degreeOfParallelism");
		ArgumentOutOfRangeException.ThrowIfGreaterThan(degreeOfParallelism, 512, "degreeOfParallelism");
	...
	{
		Func<TKey, IEnumerable<TSource>, TResult> resultSelector = resultSelector;
		ArgumentNullException.ThrowIfNull(resultSelector, "resultSelector");
	...
	{
		Func<TKey, IEnumerable<TElement>, TResult> resultSelector = resultSelector;
		ArgumentNullException.ThrowIfNull(resultSelector, "resultSelector");
	...
	{
		ArgumentNullException.ThrowIfNull(source, "source");
		ArgumentNullException.ThrowIfNull(updateAccumulatorFunc, "updateAccumulatorFunc");
		ArgumentNullException.ThrowIfNull(combineAccumulatorsFunc, "combineAccumulatorsFunc");
		ArgumentNullException.ThrowIfNull(resultSelector, "resultSelector");
	...
	{
		ArgumentNullException.ThrowIfNull(source, "source");
		ArgumentNullException.ThrowIfNull(seedFactory, "seedFactory");
		ArgumentNullException.ThrowIfNull(updateAccumulatorFunc, "updateAccumulatorFunc");
		ArgumentNullException.ThrowIfNull(combineAccumulatorsFunc, "combineAccumulatorsFunc");
		ArgumentNullException.ThrowIfNull(resultSelector, "resultSelector");
