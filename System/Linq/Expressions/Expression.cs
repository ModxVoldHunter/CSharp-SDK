...
public abstract class Expression
{
	...
	private static BinaryExpression GetUserDefinedBinaryOperator(ExpressionType binaryType, string name, Expression left, Expression right, bool liftToNull)
	{
		...
		if (left.Type.IsNullableType() && right.Type.IsNullableType())
		{
			...
			if (userDefinedBinaryOperator != null && userDefinedBinaryOperator.ReturnType.IsValueType && !userDefinedBinaryOperator.ReturnType.IsNullableType())
			{
				...
				{
					return new MethodBinaryExpression(binaryType, left, right, userDefinedBinaryOperator.ReturnType.LiftPrimitiveOrThrow(), userDefinedBinaryOperator);
				}
	...
	{
		ArgumentNullException.ThrowIfNull(expressions, "expressions");
	...
	private static BlockExpression GetOptimizedBlockExpression(IReadOnlyList<Expression> expressions)
	{
		...
		{
		case 0:
			return BlockCore(typeof(void), ReadOnlyCollection<ParameterExpression>.Empty, ReadOnlyCollection<Expression>.Empty);
		case 2:
	...
	{
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(startLine, "startLine");
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(startColumn, "startColumn");
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(endLine, "endLine");
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(endColumn, "endColumn");
	...
	{
		ArgumentNullException.ThrowIfNull(addMethod, "addMethod");
	...
	{
		CacheDict<Type, Func<Expression, string, bool, ReadOnlyCollection<ParameterExpression>, LambdaExpression>> cacheDict = s_lambdaFactories ?? (s_lambdaFactories = new CacheDict<Type, Func<Expression, string, bool, ReadOnlyCollection<ParameterExpression>, LambdaExpression>>(50));
		if (!cacheDict.TryGetValue(delegateType, out var value))
		{
			MethodInfo methodInfo = ((!LambdaExpression.CanCompileToIL) ? typeof(ExpressionCreator<>).MakeGenericType(delegateType).GetMethod("CreateExpressionFunc", BindingFlags.Static | BindingFlags.Public) : typeof(Expression<>).MakeGenericType(delegateType).GetMethod("Create", BindingFlags.Static | BindingFlags.NonPublic));
	...
	public static Expression<TDelegate> Lambda<TDelegate>(Expression body, string? name, bool tailCall, IEnumerable<ParameterExpression>? parameters)
	{
		...
		return ExpressionCreator<TDelegate>.CreateExpressionFunc(body, name, tailCall, parameters2);
	}
	...
	public static LambdaExpression Lambda(Expression body, string? name, bool tailCall, IEnumerable<ParameterExpression>? parameters)
	{
		...
		if (count > 0)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				ArgumentNullException.ThrowIfNull(parameterExpression, "parameter");
	...
	{
		ArgumentNullException.ThrowIfNull(newExpression, "newExpression");
		ArgumentNullException.ThrowIfNull(initializers, "initializers");
		ReadOnlyCollection<Expression> readOnlyCollection = initializers.ToReadOnly();
		if (readOnlyCollection.Count == 0)
		{
			return new ListInitExpression(newExpression, ReadOnlyCollection<System.Linq.Expressions.ElementInit>.Empty);
		}
	...
	{
		ArgumentNullException.ThrowIfNull(propertyAccessor, "propertyAccessor");
	...
	private static void ValidateMemberInitArgs(Type type, ReadOnlyCollection<MemberBinding> bindings)
	{
		...
		for (int count = bindings.Count; i < count; i++)
		{
			...
			ArgumentNullException.ThrowIfNull(memberBinding, "bindings");
	...
	{
		ArgumentNullException.ThrowIfNull(method, "method");
		ArgumentNullException.ThrowIfNull(arg0, "arg0");
	...
	public static MethodCallExpression Call(MethodInfo method, Expression arg0, Expression arg1)
	{
		ArgumentNullException.ThrowIfNull(method, "method");
		ArgumentNullException.ThrowIfNull(arg0, "arg0");
		ArgumentNullException.ThrowIfNull(arg1, "arg1");
		ParameterInfo[] array = ValidateMethodAndGetParameters(null, method);
	...
	public static MethodCallExpression Call(MethodInfo method, Expression arg0, Expression arg1, Expression arg2)
	{
		...
		ArgumentNullException.ThrowIfNull(arg0, "arg0");
		ArgumentNullException.ThrowIfNull(arg1, "arg1");
		ArgumentNullException.ThrowIfNull(arg2, "arg2");
		ParameterInfo[] array = ValidateMethodAndGetParameters(null, method);
	...
	public static MethodCallExpression Call(MethodInfo method, Expression arg0, Expression arg1, Expression arg2, Expression arg3)
	{
		...
		ArgumentNullException.ThrowIfNull(arg1, "arg1");
		ArgumentNullException.ThrowIfNull(arg2, "arg2");
		ArgumentNullException.ThrowIfNull(arg3, "arg3");
		ParameterInfo[] array = ValidateMethodAndGetParameters(null, method);
	...
	public static MethodCallExpression Call(MethodInfo method, Expression arg0, Expression arg1, Expression arg2, Expression arg3, Expression arg4)
	{
		...
		ArgumentNullException.ThrowIfNull(arg2, "arg2");
		ArgumentNullException.ThrowIfNull(arg3, "arg3");
		ArgumentNullException.ThrowIfNull(arg4, "arg4");
		ParameterInfo[] array = ValidateMethodAndGetParameters(null, method);
	...
	public static MethodCallExpression Call(Expression instance, string methodName, Type[]? typeArguments, params Expression[]? arguments)
	{
		...
		ArgumentNullException.ThrowIfNull(methodName, "methodName");
		if (arguments == null)
		{
	...
	private static bool IsCompatible(MethodBase m, Expression[] arguments)
	{
		...
		for (int i = 0; i < arguments.Length; i++)
		{
			...
			ArgumentNullException.ThrowIfNull(expression, "arguments");
	...
	[UnconditionalSuppressMessage("DynamicCode", "IL3050", Justification = "Creating object arrays should always be possible, as it is fundamental to the runtime.")]
	...
	{
		ArgumentNullException.ThrowIfNull(type, "type");
		ArgumentNullException.ThrowIfNull(bounds, "bounds");
		if (type == typeof(void))
		{
			throw Error.ArgumentCannotBeOfTypeVoid("type");
		}
	...
	public static NewExpression New(ConstructorInfo constructor, IEnumerable<Expression>? arguments)
	{
		...
		ArgumentNullException.ThrowIfNull(constructor.DeclaringType, "constructor");
		if ((object)constructor.DeclaringType == null)
		{
			throw new ArgumentNullException("constructor.DeclaringType");
		}
	...
	{
		ArgumentNullException.ThrowIfNull(variables, "variables");
		ReadOnlyCollection<ParameterExpression> readOnlyCollection = variables.ToReadOnly();
		for (int i = 0; i < readOnlyCollection.Count; i++)
		{
	...
	public static SwitchExpression Switch(Type? type, Expression switchValue, Expression? defaultBody, MethodInfo? comparison, IEnumerable<SwitchCase>? cases)
	{
		...
		if (comparison != null)
		{
			...
			{
				ArgumentNullException.ThrowIfNull(item, "cases");
		...
		else if (readOnlyCollection.Count != 0)
		{
			...
			{
				ArgumentNullException.ThrowIfNull(item2, "cases");
	...
	private static UnaryExpression GetUserDefinedUnaryOperator(ExpressionType unaryType, string name, Expression operand)
	{
		...
		if (type.IsNullableType())
		{
			...
			{
				return new UnaryExpression(unaryType, operand, anyStaticMethodValidated.ReturnType.LiftPrimitiveOrThrow(), anyStaticMethodValidated);
			}
		}
		return null;
	}
...
public class Expression<TDelegate> : LambdaExpression
{
	...
	{
		if (LambdaExpression.CanInterpret && preferInterpretation)
		{
			return (TDelegate)(object)new LightCompiler().CompileTop(this).CreateDelegate();
		}
		return Compile();
