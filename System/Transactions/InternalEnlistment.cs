...
internal class InternalEnlistment : ISinglePhaseNotificationInternal, IEnlistmentNotificationInternal
{
	...
	internal PreparingEnlistment PreparingEnlistment => _preparingEnlistment ?? (_preparingEnlistment = new PreparingEnlistment(this));

	internal SinglePhaseEnlistment SinglePhaseEnlistment => _singlePhaseEnlistment ?? (_singlePhaseEnlistment = new SinglePhaseEnlistment(this));
