...
internal sealed class TargetCore<TInput>
{
	...
	private readonly System.Collections.Concurrent.IProducerConsumerQueue<KeyValuePair<TInput, long>> _messages;
	...
	internal TargetCore(ITargetBlock<TInput> owningTarget, Action<KeyValuePair<TInput, long>> callAction, IReorderingBuffer reorderingBuffer, ExecutionDataflowBlockOptions dataflowBlockOptions, TargetCoreOptions targetCoreOptions)
	{
		...
		System.Collections.Concurrent.IProducerConsumerQueue<KeyValuePair<TInput, long>> messages;
		if (dataflowBlockOptions.MaxDegreeOfParallelism != 1)
		{
			System.Collections.Concurrent.IProducerConsumerQueue<KeyValuePair<TInput, long>> producerConsumerQueue = new System.Collections.Concurrent.MultiProducerMultiConsumerQueue<KeyValuePair<TInput, long>>();
			messages = producerConsumerQueue;
		}
		else
		{
			System.Collections.Concurrent.IProducerConsumerQueue<KeyValuePair<TInput, long>> producerConsumerQueue = new System.Collections.Concurrent.SingleProducerSingleConsumerQueue<KeyValuePair<TInput, long>>();
			messages = producerConsumerQueue;
		}
		_messages = messages;
	...
	private void CompleteBlockOncePossible()
	{
		...
		System.Collections.Concurrent.IProducerConsumerQueue<KeyValuePair<TInput, long>> messages = _messages;
		KeyValuePair<TInput, long> result;
