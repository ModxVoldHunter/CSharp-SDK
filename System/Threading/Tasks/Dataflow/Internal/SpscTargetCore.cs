...
internal sealed class SpscTargetCore<TInput>
{
	...
	private readonly System.Collections.Concurrent.SingleProducerSingleConsumerQueue<TInput> _messages = new System.Collections.Concurrent.SingleProducerSingleConsumerQueue<TInput>();
