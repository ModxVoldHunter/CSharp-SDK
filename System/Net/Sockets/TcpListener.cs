...
public class TcpListener : IDisposable
{
	...
	public TcpListener(IPAddress localaddr, int port)
	{
		...
		ArgumentNullException.ThrowIfNull(localaddr, "localaddr");
	...
	{
		ArgumentOutOfRangeException.ThrowIfNegative(backlog, "backlog");
		if (!_active)
		{
			CreateNewSocketIfNeeded();
	...
	{
		return TaskToAsyncResult.Begin(AcceptSocketAsync(), callback, state);
	}
	...
	{
		return TaskToAsyncResult.Begin(AcceptTcpClientAsync(), callback, state);
	}
