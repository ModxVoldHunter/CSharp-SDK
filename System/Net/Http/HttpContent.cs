...
public abstract class HttpContent : IDisposable
{
	...
	{
		HttpRequestError httpRequestError = ((e is HttpIOException ex) ? ex.HttpRequestError : HttpRequestError.Unknown);
		return new HttpRequestException(httpRequestError, System.SR.net_http_content_stream_copy_error, e);
	}
	...
	{
		return new HttpRequestException(HttpRequestError.ConfigurationLimitExceeded, System.SR.Format(CultureInfo.InvariantCulture, System.SR.net_http_content_buffersize_exceeded, maxBufferSize));
	}
}
