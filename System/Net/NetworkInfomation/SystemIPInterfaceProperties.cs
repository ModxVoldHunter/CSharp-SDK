...
internal sealed class SystemIPInterfaceProperties : IPInterfaceProperties
{
	...
	internal SystemIPInterfaceProperties(in global::Interop.IpHlpApi.IpAdapterAddresses ipAdapterAddresses)
	{
		_adapterFlags = ipAdapterAddresses.flags;
		_dnsSuffix = ipAdapterAddresses.DnsSuffix;
		_dnsEnabled = System.Net.NetworkInformation.HostInformationPal.GetEnableDns();
		...
		{
			_ipv4Properties = new SystemIPv4InterfaceProperties(in ipAdapterAddresses);
		}
