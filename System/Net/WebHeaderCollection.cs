...
public class WebHeaderCollection : NameValueCollection, ISerializable
{
	...
	private static HeaderInfoTable HeaderInfo => _headerInfo ?? (_headerInfo = new HeaderInfoTable());

	private NameValueCollection InnerCollection => _innerCollection ?? (_innerCollection = new NameValueCollection(16, CaseInsensitiveAscii.StaticInstance));
