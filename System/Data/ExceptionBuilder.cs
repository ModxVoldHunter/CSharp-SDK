...
internal static class ExceptionBuilder
{
	...
	{
		return TraceExceptionAsReturnValue(new ArgumentException(System.SR.Data_ArgumentContainsNull, paramName));
	}
	...
	{
		return ADP.NotSupported(System.SR.Batch_NotSupportedOnDataSourceBatch);
	}

	public static Exception NotSupportedOnDataSourceCommand()
	{
		return ADP.NotSupported(System.SR.Command_NotSupportedOnDataSourceCommand);
	}
	...
	{
		return _ArgumentOutOfRange(name, System.SR.Format(System.SR.DataColumn_OrdinalExceedMaximum, ordinal.ToString(CultureInfo.InvariantCulture)));
	}
	...
	{
		return _InvalidEnumArgumentException(SerializationFormat.Binary);
	}
