...
public sealed class SqlXml : INullable, IXmlSerializable
{
	...
	private static MethodInfo CreateSqlReaderMethodInfo => s_createSqlReaderMethodInfo ?? (s_createSqlReaderMethodInfo = typeof(XmlReader).GetMethod("CreateSqlReader", BindingFlags.Static | BindingFlags.NonPublic));
	...
	public static SqlXml Null => new SqlXml(_: true);
	...
	public XmlReader CreateReader()
	{
		...
		if ((object)_createSqlReaderMethodInfo == null)
		{
