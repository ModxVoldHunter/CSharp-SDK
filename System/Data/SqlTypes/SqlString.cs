...
public struct SqlString : INullable, IComparable, IXmlSerializable, IEquatable<SqlString>
{
	...
	public static readonly SqlString Null = new SqlString(_: true);
	...
	public static SqlString operator +(SqlString x, SqlString y)
	{
		...
		return new SqlString(x.m_lcid, x.m_flag, x.m_value + y.m_value, x.m_cmpInfo ?? y.m_cmpInfo);
	}
