...
internal sealed class DbConnectionOptions
{
	...
	private static readonly Regex s_connectionStringValidKeyRegex = CreateConnectionStringValidKeyRegex();

	private static readonly Regex s_connectionStringQuoteValueRegex = CreateConnectionStringQuoteValueRegex();

	private static readonly Regex s_connectionStringQuoteOdbcValueRegex = CreateConnectionStringQuoteOdbcValueRegex();
	...
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__CreateConnectionStringValidKeyRegex_0.Instance;
	}
	...
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__CreateConnectionStringQuoteValueRegex_1.Instance;
	}

	[GeneratedRegex("^\\{([^\\}\0]|\\}\\})*\\}$", RegexOptions.ExplicitCapture)]
	[GeneratedCode("System.Text.RegularExpressions.Generator", "8.0.10.26715")]
	private static Regex CreateConnectionStringQuoteOdbcValueRegex()
	{
		return _003CRegexGenerator_g_003EF74B1AE921BCEFE4BA601AA541C7A23B1CA9711EA81E8FE504B5B6446748E035A__CreateConnectionStringQuoteOdbcValueRegex_2.Instance;
	}
