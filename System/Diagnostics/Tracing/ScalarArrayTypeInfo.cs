...
internal sealed class ScalarArrayTypeInfo : TraceLoggingTypeInfo
{
	...
	{
		return s_intptr ?? (s_intptr = new ScalarArrayTypeInfo(typeof(nint[]), Statics.IntPtrType, 8));
	}

	public static TraceLoggingTypeInfo UIntPtr()
	{
		return s_uintptr ?? (s_uintptr = new ScalarArrayTypeInfo(typeof(nuint[]), Statics.UIntPtrType, 8));
	}
