...
internal sealed class NativeRuntimeEventSource : EventSource
{
	...
	private static void LogThreadPoolIOEnqueue(nint NativeOverlapped, nint Overlapped, [MarshalAs(UnmanagedType.Bool)] bool MultiDequeues, ushort ClrInstanceID)
	{
		...
		[DllImport("QCall", EntryPoint = "LogThreadPoolIOEnqueue", ExactSpelling = true)]
	...
	private void ExceptionThrown_V1(string ExceptionType, string ExceptionMessage, nint ExceptionEIP, uint ExceptionHRESULT, ushort ExceptionFlags, ushort ClrInstanceID)
	{
		throw new NotImplementedException();
	}
