...
public class XmlSchema : XmlSchemaObject
{
	...
	[XmlIgnore]
	public XmlSchemaObjectTable Attributes => _attributes ?? (_attributes = new XmlSchemaObjectTable());

	[XmlIgnore]
	public XmlSchemaObjectTable AttributeGroups => _attributeGroups ?? (_attributeGroups = new XmlSchemaObjectTable());

	[XmlIgnore]
	public XmlSchemaObjectTable SchemaTypes => _types ?? (_types = new XmlSchemaObjectTable());

	[XmlIgnore]
	public XmlSchemaObjectTable Elements => _elements ?? (_elements = new XmlSchemaObjectTable());
	...
	[XmlIgnore]
	internal XmlDocument Document => _document ?? (_document = new XmlDocument());
	...
	internal XmlNameTable NameTable => _nameTable ?? (_nameTable = new NameTable());

	internal ArrayList ImportedSchemas => _importedSchemas ?? (_importedSchemas = new ArrayList());

	internal ArrayList ImportedNamespaces => _importedNamespaces ?? (_importedNamespaces = new ArrayList());
