	...
	internal override Exception TryParseValue(string s, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr, out object typedValue)
	{
		...
		if (ex == null)
		{
			...
			if (_itemType.Variety == XmlSchemaDatatypeVariety.Union)
			{
				...
				obj = ToArray(arrayList, typeof(XmlAtomicValue[]));
			}
			else
			{
				...
				obj = ToArray(arrayList, _itemType.ListValueType);
			}
		...
		IL_011b:
		return ex;
		[UnconditionalSuppressMessage("AotAnalysis", "IL3050:AotUnfriendlyApi", Justification = "Array type is always present as it is passed in as a parameter.")]
