...
public class XmlSchemaComplexType : XmlSchemaType
{
	...
	public XmlSchemaObjectCollection Attributes => _attributes ?? (_attributes = new XmlSchemaObjectCollection());
	...
	[XmlIgnore]
	public XmlSchemaObjectTable AttributeUses => _attributeUses ?? (_attributeUses = new XmlSchemaObjectTable());

	[XmlIgnore]
	public XmlSchemaAnyAttribute? AttributeWildcard => _attributeWildcard;

	[XmlIgnore]
	internal XmlSchemaObjectTable LocalElements => _localElements ?? (_localElements = new XmlSchemaObjectTable());
