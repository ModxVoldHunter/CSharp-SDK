...
internal abstract class XmlBaseConverter : XmlValueConverter
{
	...
	protected Type DefaultClrListType => _clrListTypeDefault;
	...
	protected static byte[] StringToHexBinary(string value)
	{
		try
		{
			return XmlConvert.FromBinHexString(value.AsSpan().Trim(XmlConvert.WhitespaceChars), allowOddCount: false);
		}
