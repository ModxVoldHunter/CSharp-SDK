...
{
	private static readonly Numeric10FacetsChecker s_numeric10FacetsChecker = new Numeric10FacetsChecker(0m, 18446744073709551615m);
	...
	internal override Type ListValueType => typeof(ulong[]);
