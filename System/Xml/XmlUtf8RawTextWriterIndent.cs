...
internal sealed class XmlUtf8RawTextWriterIndent : XmlUtf8RawTextWriter
{
	...
	private void Init(XmlWriterSettings settings)
	{
		...
		if (_newLineOnAttributes)
		{
			XmlUtf8RawTextWriter.ValidateContentChars(_indentChars, "IndentChars", allowOnlyWhitespace: true);
			XmlUtf8RawTextWriter.ValidateContentChars(_newLineChars, "NewLineChars", allowOnlyWhitespace: true);
			return;
		}
		XmlUtf8RawTextWriter.ValidateContentChars(_indentChars, "IndentChars", allowOnlyWhitespace: false);
		if (_newLineHandling != 0)
		{
			XmlUtf8RawTextWriter.ValidateContentChars(_newLineChars, "NewLineChars", allowOnlyWhitespace: false);
		}
	}
