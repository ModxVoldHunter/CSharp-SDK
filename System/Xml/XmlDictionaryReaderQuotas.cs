...
public sealed class XmlDictionaryReaderQuotas
{
	...
	public int MaxStringContentLength
	{
		...
		set
		{
			if (_readOnly)
			{
				throw new InvalidOperationException(System.SR.Format(System.SR.QuotaIsReadOnly, "MaxStringContentLength"));
			}
	...
	public int MaxArrayLength
	{
		...
		set
		{
			if (_readOnly)
			{
				throw new InvalidOperationException(System.SR.Format(System.SR.QuotaIsReadOnly, "MaxArrayLength"));
			}
			ArgumentOutOfRangeException.ThrowIfNegativeOrZero(value, "value");
	...
	public int MaxBytesPerRead
	{
		...
		set
		{
			if (_readOnly)
			{
				throw new InvalidOperationException(System.SR.Format(System.SR.QuotaIsReadOnly, "MaxBytesPerRead"));
			}
			ArgumentOutOfRangeException.ThrowIfNegativeOrZero(value, "value");
	...
	public int MaxDepth
	{
		...
		set
		{
			if (_readOnly)
			{
				throw new InvalidOperationException(System.SR.Format(System.SR.QuotaIsReadOnly, "MaxDepth"));
			}
			ArgumentOutOfRangeException.ThrowIfNegativeOrZero(value, "value");
			_maxDepth = value;
	...
	public int MaxNameTableCharCount
	{
		...
		set
		{
			if (_readOnly)
			{
				throw new InvalidOperationException(System.SR.Format(System.SR.QuotaIsReadOnly, "MaxNameTableCharCount"));
			}
			ArgumentOutOfRangeException.ThrowIfNegativeOrZero(value, "value");
	...
	public void CopyTo(XmlDictionaryReaderQuotas quotas)
	{
		...
		if (quotas._readOnly)
		{
			throw new InvalidOperationException(System.SR.QuotaCopyReadOnly);
		}
