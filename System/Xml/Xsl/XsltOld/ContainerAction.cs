...
internal class ContainerAction : CompiledAction
{
	...
	private void CompileInclude(Compiler compiler)
	{
		...
		CompiledAction.CheckEmpty(compiler);
	}
	...
	internal static void CompileNamespaceAlias(Compiler compiler)
	{
		...
		CompiledAction.CheckRequiredAttribute(text, "stylesheet-prefix");
		CompiledAction.CheckRequiredAttribute(text2, "result-prefix");
		CompiledAction.CheckEmpty(compiler);
	...
	internal static void CompileKey(Compiler compiler)
	{
		...
		CompiledAction.CheckRequiredAttribute(num != -1, "match");
		CompiledAction.CheckRequiredAttribute(num2 != -1, "use");
		CompiledAction.CheckRequiredAttribute(xmlQualifiedName != null, "name");
