...
{
	internal static ReadOnlySpan<int> KatmaiTimeScaleMultiplicator => RuntimeHelpers.CreateSpan<int>((RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
