...
internal static class XmlConverter
{
	...
	public static bool ToBoolean(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "Boolean", exception2);
		}
	}
	...
	public static long ToInt64(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "Int64", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(value, "Int64", exception3);
		}
	}
	...
	public static float ToSingle(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "float", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(value, "float", exception3);
		}
	}
	...
	public static double ToDouble(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "double", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(value, "double", exception3);
		}
	}
	...
	public static decimal ToDecimal(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "decimal", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(value, "decimal", exception3);
		}
	}
	...
	public static DateTime ToDateTime(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "DateTime", exception2);
		}
	}
	...
	public static UniqueId ToUniqueId(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "UniqueId", exception2);
		}
	}
	...
	public static TimeSpan ToTimeSpan(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "TimeSpan", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(value, "TimeSpan", exception3);
		}
	}
	...
	public static Guid ToGuid(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "Guid", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(value, "Guid", exception3);
		}
	}
	...
	public static ulong ToUInt64(string value)
	{
		...
		{
			throw XmlExceptionHelper.CreateConversionException(value, "UInt64", exception2);
		}
		catch (OverflowException exception3)
		{
			throw XmlExceptionHelper.CreateConversionException(value, "UInt64", exception3);
		}
	}
	...
	public static void ToQualifiedName(string qname, out string prefix, out string localName)
	{
		...
		{
			throw new XmlException(System.SR.Format(System.SR.XmlInvalidQualifiedName, qname));
		}
		prefix = qname.Substring(0, num).Trim();
		localName = qname.Substring(num + 1).Trim();
	}
	...
	{
		return BitConverter.SingleToUInt32Bits(value) == 2147483648u;
	}

	private static bool IsNegativeZero(double value)
	{
		return BitConverter.DoubleToUInt64Bits(value) == 9223372036854775808uL;
	}
	...
	{
		return !chars.ContainsAnyExcept(s_whitespaceChars);
	}

	public static bool IsWhitespace(ReadOnlySpan<byte> bytes)
	{
		return !bytes.ContainsAnyExcept(s_whitespaceBytes);
	}
	...
	{
		int num = chars.IndexOfAny(s_whitespaceChars);
		if (num < 0)
		{
			return chars.Length;
		}
		Span<char> span = chars.Slice(num + 1);
	...
	{
		int num = s.AsSpan().IndexOfAny(s_whitespaceChars);
		if (num < 0)
		{
			return s;
		}
		int num2 = s.Length - 1;
		ReadOnlySpan<char> readOnlySpan = s.AsSpan(num + 1);
		...
		return string.Create(num2, s, delegate(Span<char> chars, string s)
		{
			int num3 = 0;
			foreach (char c in s)
			{
