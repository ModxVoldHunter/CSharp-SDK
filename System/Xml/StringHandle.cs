...
internal sealed class StringHandle : IEquatable<StringHandle>
{
	...
	public string GetString(XmlNameTable nameTable)
	{
		return _type switch
		{
			...
			StringHandleType.ConstString => nameTable.Add(s_constStrings[_key]), 
			_ => _bufferReader.GetEscapedString(_offset, _length, nameTable), 
		};
	}
	...
	public string GetString()
	{
		return _type switch
		{
			...
			StringHandleType.ConstString => s_constStrings[_key], 
			_ => _bufferReader.GetEscapedString(_offset, _length), 
		};
	}
