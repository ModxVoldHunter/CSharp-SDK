...
public class XPathDocument : IXPathNavigable
{
	...
	{
		XPathNodeRef value = new XPathNodeRef(pageElem, idxElem);
		if (_mapNmsp == null || !_mapNmsp.TryGetValue(value, out value))
		{
			pageNmsp = null;
			return 0;
		}
	...
	{
		if (_idValueMap == null || !_idValueMap.TryGetValue(id, out var value))
		{
			pageElem = null;
			return 0;
		}
