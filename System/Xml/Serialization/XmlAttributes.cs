...
public class XmlAttributes
{
	...
	public XmlAttributes(ICustomAttributeProvider provider)
	{
		...
		for (int i = 0; i < customAttributes.Length; i++)
		{
			...
			else if (customAttributes[i] is XmlAnyElementAttribute xmlAnyElementAttribute2)
			{
				if (string.IsNullOrEmpty(xmlAnyElementAttribute2.Name) && xmlAnyElementAttribute2.GetNamespaceSpecified() && xmlAnyElementAttribute2.Namespace == null)
				{
