...
public abstract class XmlSerializationWriter : XmlSerializationGeneratedCode
{
	...
	protected void WriteTypedPrimitive(string? name, string? ns, object o, bool xsiType)
	{
		...
		case TypeCode.String:
			...
			break;
		case TypeCode.Int32:
			flag4 = XmlConvert.TryFormat((int)o, _primitivesBuffer, out charsWritten);
			text2 = "int";
			break;
		case TypeCode.Boolean:
			flag4 = XmlConvert.TryFormat((bool)o, _primitivesBuffer, out charsWritten);
			text2 = "boolean";
			break;
		case TypeCode.Int16:
			flag4 = XmlConvert.TryFormat((short)o, _primitivesBuffer, out charsWritten);
			text2 = "short";
			break;
		case TypeCode.Int64:
			flag4 = XmlConvert.TryFormat((long)o, _primitivesBuffer, out charsWritten);
			text2 = "long";
			break;
		case TypeCode.Single:
			flag4 = XmlConvert.TryFormat((float)o, _primitivesBuffer, out charsWritten);
			text2 = "float";
			break;
		case TypeCode.Double:
			flag4 = XmlConvert.TryFormat((double)o, _primitivesBuffer, out charsWritten);
			text2 = "double";
			break;
		case TypeCode.Decimal:
			flag4 = XmlConvert.TryFormat((decimal)o, _primitivesBuffer, out charsWritten);
			text2 = "decimal";
			break;
		case TypeCode.DateTime:
			flag4 = TryFormatDateTime((DateTime)o, _primitivesBuffer, out charsWritten);
			text2 = "dateTime";
			break;
		case TypeCode.Char:
			flag4 = XmlConvert.TryFormat((ushort)(char)o, (Span<char>)_primitivesBuffer, out charsWritten);
			text2 = "char";
			ns2 = "http://microsoft.com/wsdl/types/";
			break;
		case TypeCode.Byte:
			flag4 = XmlConvert.TryFormat((byte)o, _primitivesBuffer, out charsWritten);
			text2 = "unsignedByte";
			break;
		case TypeCode.SByte:
			flag4 = XmlConvert.TryFormat((sbyte)o, _primitivesBuffer, out charsWritten);
			text2 = "byte";
			break;
		case TypeCode.UInt16:
			flag4 = XmlConvert.TryFormat((ushort)o, _primitivesBuffer, out charsWritten);
			text2 = "unsignedShort";
			break;
		case TypeCode.UInt32:
			flag4 = XmlConvert.TryFormat((uint)o, _primitivesBuffer, out charsWritten);
			text2 = "unsignedInt";
			break;
		case TypeCode.UInt64:
			flag4 = XmlConvert.TryFormat((ulong)o, _primitivesBuffer, out charsWritten);
			text2 = "unsignedLong";
			break;
		default:
			if (type == typeof(XmlQualifiedName))
			...
			if (type == typeof(Guid))
			{
				flag4 = XmlConvert.TryFormat((Guid)o, _primitivesBuffer, out charsWritten);
				text2 = "guid";
				ns2 = "http://microsoft.com/wsdl/types/";
				break;
			}
			if (type == typeof(TimeSpan))
			{
				flag4 = XmlConvert.TryFormat((TimeSpan)o, _primitivesBuffer, out charsWritten);
				text2 = "TimeSpan";
				ns2 = "http://microsoft.com/wsdl/types/";
				break;
			}
			if (type == typeof(DateTimeOffset))
			{
				flag4 = XmlConvert.TryFormat((DateTimeOffset)o, _primitivesBuffer, out charsWritten);
	...
	protected void WriteStartElement(string name, string? ns, object? o, bool writePrefixed, XmlSerializerNamespaces? xmlns)
	{
		...
		if (flag && prefix == null && !string.IsNullOrEmpty(ns))
		{
			prefix = NextPrefix();
		}
		...
		if (_namespaces != null)
		{
			foreach (XmlQualifiedName namespace2 in _namespaces.Namespaces)
			{
				...
				if (name2.Length == 0 && string.IsNullOrEmpty(@namespace))
				{
					continue;
				}
	...
	private string GetId(object o, bool addToReferencesList)
	{
		...
		if (text == null)
		{
			...
			handler.AppendFormatted(_idBase);
			handler.AppendLiteral("id");
			handler.AppendFormatted(++_nextId);
	...
	private void WriteReferencedElement(string name, string ns, object o, Type ambientType)
	{
		...
		WriteStartElement((name.Length == 0) ? typeEntry.typeName : name, ns ?? typeEntry.typeNs, null, writePrefixed: true);
		WriteId(o, addToReferencesList: false);
		if (ambientType != type)
		{
	...
	protected void WriteNamespaceDeclarations(XmlSerializerNamespaces? xmlns)
	{
		if (xmlns != null)
		{
			foreach (XmlQualifiedName namespace2 in xmlns.Namespaces)
			{
				...
				string text = (string.IsNullOrEmpty(@namespace) ? null : Writer.LookupPrefix(@namespace));
