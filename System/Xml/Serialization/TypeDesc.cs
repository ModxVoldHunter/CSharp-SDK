...
internal sealed class TypeDesc
{
	...
	internal string CSharpName => _cSharpName ?? (_cSharpName = ((_type == null) ? CodeIdentifier.GetCSharpName(_fullName) : CodeIdentifier.GetCSharpName(_type)));
	...
	{
		return _arrayTypeDesc ?? (_arrayTypeDesc = new TypeDesc(null, _name + "[]", _fullName + "[]", TypeKind.Array, null, TypeFlags.Reference | (_flags & TypeFlags.UseReflection), this));
	}
