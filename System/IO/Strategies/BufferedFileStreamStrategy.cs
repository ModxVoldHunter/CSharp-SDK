...
internal sealed class BufferedFileStreamStrategy : FileStreamStrategy
{
	...
	[CompilerGenerated]
	private struct _003CReadAsyncSlowPath_003Ed__37 : IAsyncStateMachine
	{
	...
	[StructLayout(LayoutKind.Auto)]
	[CompilerGenerated]
	private struct _003CWriteAsyncSlowPath_003Ed__48 : IAsyncStateMachine
	{
		public int _003C_003E1__state;
	...
	public override Task<int> ReadAsync(byte[] buffer, int offset, int count, CancellationToken cancellationToken)
	{
		...
		return _lastSyncCompletedReadTask.GetTask(valueTask.Result);
	}
	...
	[AsyncStateMachine(typeof(_003CReadAsyncSlowPath_003Ed__37))]
	...
	{
		Unsafe.SkipInit(out _003CReadAsyncSlowPath_003Ed__37 stateMachine);
	...
	[AsyncStateMachine(typeof(_003CWriteAsyncSlowPath_003Ed__48))]
	[AsyncMethodBuilder(typeof(PoolingAsyncValueTaskMethodBuilder))]
	...
	{
		Unsafe.SkipInit(out _003CWriteAsyncSlowPath_003Ed__48 stateMachine);
	...
	internal override void Flush(bool flushToDisk)
	{
		...
		else if (_readLen > 0 && _strategy.CanSeek)
		{
			FlushRead();
		}
