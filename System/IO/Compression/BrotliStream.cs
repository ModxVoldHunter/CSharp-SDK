...
public sealed class BrotliStream : Stream
{
	...
	{
		WriteCore(new ReadOnlySpan<byte>(ref value));
	}
	...
	{
		throw new InvalidDataException(System.SR.BrotliStream_Decompress_TruncatedData);
	}
	...
	public BrotliStream(Stream stream, CompressionMode mode, bool leaveOpen)
	{
		...
		case CompressionMode.Compress:
			...
			_encoder.SetQuality(4);
			_encoder.SetWindow(22);
			break;
