...
public static class Console
{
	...
	private static TextWriter CreateOutputWriter(Stream outputStream)
	{
		...
		{
			return TextWriter.Synchronized(new StreamWriter(outputStream, OutputEncoding.RemovePreamble(), 256, leaveOpen: true)
			{
				AutoFlush = true
			});
		}
	...
	{
		ArgumentNullException.ThrowIfNull(newIn, "newIn");
	...
	{
		ArgumentNullException.ThrowIfNull(newOut, "newOut");
	...
	{
		ArgumentNullException.ThrowIfNull(newError, "newError");
