...
internal sealed class ArrayPoolEventSource : EventSource
{
	...
	internal unsafe void BufferRented(int bufferId, int bufferSize, int poolId, int bucketId)
	{
		...
		ptr->Size = 4;
		ptr->DataPointer = (nint)(&bufferId);
		ptr->Reserved = 0;
		ptr[1].Size = 4;
		ptr[1].DataPointer = (nint)(&bufferSize);
		ptr[1].Reserved = 0;
		ptr[2].Size = 4;
		ptr[2].DataPointer = (nint)(&poolId);
		ptr[2].Reserved = 0;
		ptr[3].Size = 4;
		ptr[3].DataPointer = (nint)(&bucketId);
		ptr[3].Reserved = 0;
