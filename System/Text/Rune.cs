...
public readonly struct Rune : IComparable, IComparable<Rune>, IEquatable<Rune>, ISpanFormattable, IFormattable, IUtf8SpanFormattable
{
	...
	{
		return TryEncodeToUtf8(utf8Destination, out bytesWritten);
	}
