		...
		fixed (byte* ptr4 = &Char2val[0])
		{
			fixed (char* ptr = &chars[index])
			{
				...
				for (char* ptr3 = ptr + count; ptr2 < ptr3; ptr2 += 4)
				{
					...
					if ((c | c2 | c3 | c4) >= 128)
					{
						throw new FormatException(System.SR.Format(System.SR.XmlInvalidBase64Sequence, new string(ptr2, 0, 4), index + (int)(ptr2 - ptr)));
					}
					int v = ptr4[(int)c];
					int v2 = ptr4[(int)c2];
			...
			fixed (char* ptr = &chars[charIndex])
			{
				fixed (byte* ptr4 = &bytes[byteIndex])
				{
					...
					for (; ptr2 < ptr3; ptr2 += 4)
					{
						...
						if ((c | c2 | c3 | c4) >= 128)
						{
							throw new FormatException(System.SR.Format(System.SR.XmlInvalidBase64Sequence, new string(ptr2, 0, 4), charIndex + (int)(ptr2 - ptr)));
						}
						int num = ptr7[(int)c];
			...
			fixed (byte* ptr = &chars[charIndex])
			{
				fixed (byte* ptr4 = &bytes[byteIndex])
				{
					...
					for (; ptr2 < ptr3; ptr2 += 4)
					{
						...
						if ((b | b2 | b3 | b4) >= 128)
						{
							throw new FormatException(System.SR.Format(System.SR.XmlInvalidBase64Sequence, "?", charIndex + (int)(ptr2 - ptr)));
						}
						int num = ptr7[(int)b];
