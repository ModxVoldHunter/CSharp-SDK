...
internal sealed class ISO2022Encoding : DBCSCodePageEncoding
{
	...
	private static ReadOnlySpan<int> TableBaseCodePages => RuntimeHelpers.CreateSpan<int>((RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);

	private static ReadOnlySpan<ushort> HalfToFullWidthKanaTable => RuntimeHelpers.CreateSpan<ushort>((RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
