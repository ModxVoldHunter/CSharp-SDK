...
public class TypeDelegator : TypeInfo
{
	...
	{
		ArgumentNullException.ThrowIfNull(delegatingType, "delegatingType");
	...
	{
		return typeImpl.GetFunctionPointerCallingConventions();
	}

	public override Type[] GetFunctionPointerParameterTypes()
	{
		return typeImpl.GetFunctionPointerParameterTypes();
	}

	public override Type GetFunctionPointerReturnType()
	{
		return typeImpl.GetFunctionPointerReturnType();
	}
