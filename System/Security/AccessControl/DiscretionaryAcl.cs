...
public sealed class DiscretionaryAcl : CommonAcl
{
	...
	internal DiscretionaryAcl(bool isContainer, bool isDS, RawAcl rawAcl, bool trusted)
		: base(isContainer, isDS, rawAcl ?? new RawAcl(isDS ? GenericAcl.AclRevisionDS : GenericAcl.AclRevision, 0), trusted, isDacl: true)
	{
	}

	public void AddAccess(AccessControlType accessType, SecurityIdentifier sid, int accessMask, InheritanceFlags inheritanceFlags, PropagationFlags propagationFlags)
	{
		CommonAcl.CheckAccessType(accessType);
