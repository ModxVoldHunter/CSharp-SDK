...
public struct ECCurve
{
	...
	public Oid Oid
	{
		...
		private set
		{
			ArgumentNullException.ThrowIfNull(value, "Oid");
			if (string.IsNullOrEmpty(value.Value) && string.IsNullOrEmpty(value.FriendlyName))
			{
				throw new ArgumentException(System.SR.Format(System.SR.Cryptography_InvalidCurveOid, value.Value));
			}
			_oid = value;
		}
	}
	...
	{
		ArgumentNullException.ThrowIfNull(oidFriendlyName, "oidFriendlyName");
	...
	public void Validate()
	{
		if (IsNamed)
		{
			...
			{
				throw new CryptographicException(System.SR.Format(System.SR.Cryptography_InvalidCurveOid, Oid?.Value));
			}
		}
		else if (IsExplicit)
		{
