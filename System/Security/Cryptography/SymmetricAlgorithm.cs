...
public abstract class SymmetricAlgorithm : IDisposable
{
	...
	{
		return CryptoConfigForwarder.CreateFromName<SymmetricAlgorithm>(algName);
	}
	...
	{
		ArgumentOutOfRangeException.ThrowIfNegative(plaintextLength, "plaintextLength");
	...
	{
		ArgumentOutOfRangeException.ThrowIfNegative(plaintextLength, "plaintextLength");
		ArgumentOutOfRangeException.ThrowIfNegativeOrZero(feedbackSizeInBits, "feedbackSizeInBits");
